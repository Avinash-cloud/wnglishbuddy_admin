...
export function middleware(req) {
  ...
  const protectedRoutes = [ '/courses', '/module','/blogs','/teachers', '/institutions','/students','/payments','/classRecordings','/store','/orders'];
...
export const config = {
  matcher: ['/login/:path*', '/courses/:path*','/module/:path*','/blogs/:path*','/teachers/:path*','/institutions/:path*','/students/:path*','/payments/:path*','/classRecordings/:path*','/store/:path*','/orders/:path*',] // Protect login, signup, and profile routes
};
