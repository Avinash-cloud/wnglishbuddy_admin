                ...
                <div className="justify-center items-center flex flex-col mt-16" >
                    <form className=" w-2/4 justify-center flex flex-col book_from" onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-center gap-4">
                            ...
                            <button type="submit" className="bg-blue-500  text-white p-2 w-1/5 font-serif rounded-lg mt-8">
                                Save Edited Book
                            </button>
                            <a href="/store">
                                <button type="button" className="bg-black  text-white p-2 w-1/7 font-serif rounded-lg mt-8">
                                    Back
                                </button>
                            </a>
                        </div>
