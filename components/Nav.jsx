    ...
    return (
        <aside className={(show ? 'left-0' : '-left-full') + " top-0 text-black p-4 fixed w-full bg-white h-full md:static md:w-auto transition-all overflow-y-auto overflow-x-hidden "}>
            ...
            <nav className="flex flex-col gap-2 bg-white w-[11rem] overflow-auto">
                ...
                <Link href={'/sessions'} className={` ${pathname === '/sessions' ? activeLink : inactiveLink}`}>
                ...
                <Link href={'/contactus'} className={` ${pathname === '/contactus' ? activeLink : inactiveLink}`}>
                    ...
                    <img src="data:image/png;base64," alt="icon" size={20} strokeWidth={1.75} className={` ${pathname === '/contactus' ? activeIcon : inactiveIcon}`}></img>
                    Ccontact us
                </Link>
